...
Locator: locator('button:has-text("✨ Enhance with AI")').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("✨ Enhance with AI")').first()

```

```yaml
- banner:
  - text: VLSI Physical Design Ocean
  - link "🏠 Portal Home":
    - /url: /
  - button "🚪 Logout"
- main:
  - link "← Back to Dashboard":
    - /url: /resume
  - heading "Test Resume" [level=1]
  - list:
    - listitem: 👤 Personal Details
    - listitem: 🎯 Career Objective
    - listitem: 💼 Work Experience
    - listitem: 🚀 Projects
    - listitem: 🎓 Education
    - listitem: 📜 Professional Training
    - listitem: 🛠️ Technical Skills
    - listitem: 🖋️ Declaration
    - listitem: 📊 ATS Score
    - listitem: ⚙️ Advanced & Settings
  - heading "Work Experience" [level=2]
  - button "+ Add Experience"
  - text: Live Preview
  - combobox "Select Resume Template":
    - option "Modern"
    - option "Classic"
    - option "Executive"
    - option "Professional" [selected]
  - button "Export As ▼"
  - text: PDF Preview Loaded (Test Mode) ✓ All Changes Saved
- button "?"
```
