...
- Name: ui.spec.js >> UI & Accessibility Validation >> Should not have any console errors on render
- Location: tests\ui.spec.js:31:3
...
Call log:
  - navigating to "http://localhost:5173/resume/edit/test-ui-id", waiting until "load"
