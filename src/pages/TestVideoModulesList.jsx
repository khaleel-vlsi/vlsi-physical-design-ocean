  ...
  return (
    <div className={styles.modulesContainer}>
      <header className={styles.headerSection}>
        <h1 className={styles.pageTitle}>Recorded Classes (Private Test)</h1>
        ...
        {videoModulesArray.map((mod) => {
          ...
          return (
            <div 
              ...
              onClick={() => {
                if (!isActuallyLocked) {
                  navigate(`/test-videos/module/${mod.id}`);
                } else {
            ...
            >
              <div className={styles.moduleCard}>
                <div className={styles.thumbnailContainer}>
                  {mod.thumbnail && (
                    <img src={mod.thumbnail} alt={mod.title} className={styles.thumbnailImage} />
                  )}
