...
fs.writeFileSync('extracted_content_module1.json', JSON.stringify(finalContent, null, 2));
console.log(`Extracted ${finalContent.length} items to extracted_content_module1.json using Deep Walker.`);
