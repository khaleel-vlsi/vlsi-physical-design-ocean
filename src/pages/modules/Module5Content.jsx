    ...
    <div className={styles.moduleLayout}>
      ...
      <div className={styles.mainContent}>
        <div className={styles.contentCard}>
          ...
          id="h.m8ku8drh5kvu" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">Introduction to RTL, Digital Design &amp; VLSI Context</span>` }} />
          <hr className={styles.divider} />
          id="h.dtzc9gb860b9" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">1. What is Digital Design? (Very First Concept)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.yg8oodia7a46" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">2. What is VLSI and Where RTL Fits?</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.ip9pcnlrjz36" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">3. What is RTL (Register Transfer Level)?</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.o5xoutsz8m1s" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">4. Why RTL is Needed (Very Important for Students)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.j63doko7jmix" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">5. Why Verilog/SystemVerilog for RTL?</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.kdgyqyhbwtw1" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">6. Hardware Thinking vs Software Thinking</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.v6d5jczb7jbb" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">7. What is a Register?</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.kld5mmyyfobn" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">8. Combinational vs Sequential Logic (Foundation)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.e8domf7xsr9j" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">9. RTL Coding Styles (Overview – Will Deep Dive Later)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.basb23g7ng2d" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">10. What You Will Learn in This RTL Course (Assurance)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.1aelv9p80tv" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">Class 1 Summary (For Students)</span>` }} />
          ...
          id="h.74z8h25uqs77" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">Verilog Basics | Module Structure | RTL Building Blocks</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.gcd7elyg9uz9" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">1. What is Verilog? (Clear Definition)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.by9uomhkolfl" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">2. Structure of a Verilog Design</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.28zi514h50fk" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">3. Verilog Module Syntax (Very Important)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.vfonlj9bg2x7" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">4. Ports in Verilog (Inputs &amp; Outputs)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.7ac2qyp719q2" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">5. Data Types in Verilog (Critical for Beginners)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.h53gftomvfpb" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c61 c19">6. Continuous Assignment (</span><span class="c52 c19 c61">assign</span><span class="c13">)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.m7s84vd7flgd" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">7. Always Block (Core of RTL)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.tphwepprqgeo" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">8. Combinational Always Block</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.eynqwsayztpp" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">9. Sequential Always Block (Clocked Logic)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.ev0lblh6csk3" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">10. Blocking vs Non-Blocking Assignment (Very Important)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.pu2ztucqcif3" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">11. Reset in Sequential Logic</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.pjulptur55v0" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">12. Simulation vs Synthesis (Must Understand)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.21sqxksvnkwx" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">13. First RTL Design Flow</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.zhvjobk4l0nf" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">Class 2 Summary</span>` }} />
          ...
          id="h.fl09j03kkj5e" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">Combinational Circuits using Verilog RTL</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.grmpxcwlnp8b" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">1. What is a Combinational Circuit?</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.pawyfl1nsuij" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">2. Coding Styles in RTL (VERY IMPORTANT)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.5b0fxle2bli3" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">3. HALF ADDER</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.gbk4rktroep" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">4. FULL ADDER</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.fl15ufrachmh" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">5. 2:1 MULTIPLEXER</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">end</span>` }} />
          <hr className={styles.divider} />
          id="h.panu9x409qtz" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">6. DECODER (2:4 Decoder)</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.s7o2ryhunl90" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">7. ENCODER (4:2 Encoder)</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.nz3bzpa11mpc" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">8. MAGNITUDE COMPARATOR (1-bit)</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.k7f99k1zgxap" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">CLASS 3 SUMMARY</span>` }} />
          ...
          id="h.ujnh3scnlwyr" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">Sequential Circuits using Verilog RTL (Beginner → Industry Ready)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.ku6i0wse76xc" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">1. What is a Sequential Circuit?</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.j69kgrpxuhwo" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">2. Clock – Heart of Sequential Logic</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.cp5vbp3i5za3" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">3. Latch vs Flip-Flop (VERY IMPORTANT)</span>` }} />
          <div className={styles.tableContainer}>
          ...
          <hr className={styles.divider} />
          id="h.kef2f4arjyfj" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">4. SR LATCH (Basic Memory)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.89xrltbetqei" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">5. D LATCH</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.ufga5pqft041" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">6. FLIP-FLOPS (MAIN FOCUS)</span>` }} />
          <hr className={styles.divider} />
          id="h.7xtitp339ff9" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">6.1 D Flip-Flop (MOST IMPORTANT)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.wrf933hqwr1k" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">7. Reset in Flip-Flops</span>` }} />
          ...
          <hr className={styles.divider} />
          <AdUnit slotId="slot_module5content_mid1" />
          ...
          <hr className={styles.divider} />
          id="h.aiceqi2h8tei" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">7.2 Synchronous Reset</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">always @(posedge clk) begin</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">    if (rst)</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">        q &lt;= 0;</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">    else</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.wwn0tnupcvy" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">8. JK Flip-Flop</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.mh26rtnzw0qq" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">9. T Flip-Flop</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.v1s209fav56d" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">10. SR Flip-Flop (Clocked)</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.57pao5qlbeid" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">11. Registers (Multiple Flip-Flops)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.z5wq1pcf6y8h" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">12. Blocking vs Non-Blocking (INTERVIEW MUST)</span>` }} />
          <div className={styles.tableContainer}>
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">q &lt;= d;</span>` }} />
          <hr className={styles.divider} />
          id="h.vce6qcmaaduv" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">CLASS 4 SUMMARY</span>` }} />
          ...
          id="h.docwik11gder" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">Counters &amp; Shift Registers using Verilog RTL</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.ttcz8i9akla6" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">1. What is a Counter?</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.yzoi8bf1lsii" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">2. Types of Counters</span>` }} />
          <div className={styles.tableContainer}>
          ...
          <hr className={styles.divider} />
          id="h.x0j3qka560h1" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">3. 4-Bit UP Counter</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.ai0bpmdgloa3" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">4. 4-Bit DOWN Counter</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.dk7fyyk8cq7v" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">5. UP-DOWN Counter</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.nv4nt99uavkh" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">6. MOD-N Counter (Example: MOD-10)</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.d4khyohb3lpl" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">7. Ring Counter</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.g3gtmua08hf3" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">8. Johnson Counter</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.1o3l2dq8fx73" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">9. Shift Registers</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.c9bzsrisxr69" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">10. Types of Shift Registers</span>` }} />
          <div className={styles.tableContainer}>
          ...
          <hr className={styles.divider} />
          id="h.xsnm65g01esi" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">11. SISO Shift Register</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.d5tp8vgiayke" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">12. SIPO Shift Register</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.5zhioigd56h" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">13. PISO Shift Register</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.1alrzkml0az3" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">14. PIPO Shift Register</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.go2goy8tiytg" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">CLASS 5 SUMMARY</span>` }} />
          ...
          id="h.ar85nikvs3ko" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c61 c19">Finite State Machines (FSM) – COMPLETE BEGINNER TO INDUSTRY LEVEL</span>` }} />
          <hr className={styles.divider} />
          id="h.pcn3jwldyuik" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">1. What is an FSM?</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.aek0kf35o7oz" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">2. Why FSM is Important in Industry?</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.welnei2ekw7q" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">3. FSM Basic Blocks</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">+------------------+</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">+------------------+</span>` }} />
          <hr className={styles.divider} />
          id="h.5tl26fd6xcgk" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">4. Types of FSM</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.z82hwl6pi3r4" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">5. FSM Design Steps (VERY IMPORTANT)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.ot0ilbrtvuik" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">6. Example 1: Simple FSM (2-State Switch)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.9ueyuqfku256" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">7. RTL Coding Style for FSM (STANDARD STYLE)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.90zjvrib1vaz" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">8. FSM RTL Code (Moore FSM)</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.gqbl9nq4x5rx" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">9. Example 2: Traffic Light Controller (Moore FSM)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.owjzb5juxqzz" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">10. RTL Code: Traffic Light FSM</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.iy2e057402dr" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">11. Mealy FSM Example (Sequence Detector – 101)</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.nbplqlj3i6ng" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">12. Common FSM Mistakes (INTERVIEW)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.nzyt06qme14" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">13. FSM Coding Best Practices</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.k57zp0y97kha" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">CLASS 6 SUMMARY</span>` }} />
          ...
          id="h.qtj0zu56ydyq" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">RTL Coding Guidelines, Simulation vs Synthesis &amp; Timing-Safe Coding</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.nze0exmez4aj" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">1. Why RTL Coding Guidelines are IMPORTANT?</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.5xf4uxszs519" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">2. Simulation vs Synthesis (MOST CONFUSING FOR BEGINNERS)</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">    a &lt;= b;</span>` }} />
          <hr className={styles.divider} />
          id="h.z2ogiqjkj1is" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">3. Blocking vs Non-Blocking Assignments</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.mlgc481ezmg3" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">4. Latch vs Flip-Flop (VERY IMPORTANT)</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">end</span>` }} />
          <hr className={styles.divider} />
          id="h.xys8vqed6yer" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">5. How Latches are Accidentally Created</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">end</span>` }} />
          <hr className={styles.divider} />
          id="h.d64ka975nyv1" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">6. Reset Types in RTL</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">end</span>` }} />
          <hr className={styles.divider} />
          id="h.9hb5kdm45d9r" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">7. Clock Gating (POWER SAVING CONCEPT)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.5mtyo5tgxwb0" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">8. Combinational Logic Coding Rules</span>` }} />
          ...
          <hr className={styles.divider} />
          <AdUnit slotId="slot_module5content_mid2" />
          ...
          <hr className={styles.divider} />
          id="h.49149b85lwbb" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">10. Sensitivity List (Beginner Mistake)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.btvb425qwuxx" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">11. Timing Concepts (Beginner Level)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.5cnct2cqy8jw" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">12. Interview-Level RTL Rules</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.gcvzrtohbmqf" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">CLASS 7 SUMMARY</span>` }} />
          ...
          id="h.ahz53vwmle3l" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">Combinational Circuits using RTL (Behavioral, Dataflow &amp; Structural)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.nynen1usla3u" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">1. What is a Combinational Circuit?</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.ei86jsb0t6yk" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">2. RTL Coding Styles (VERY IMPORTANT)</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">Carry = A &amp; B</span>` }} />
          <hr className={styles.divider} />
          id="h.1zu9hgk9f7fe" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">3.1 Half Adder – Dataflow Style</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">module half_adder_df (</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">    input A, B,</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.ika7ygbivx63" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">3.2 Half Adder – Behavioral Style</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">module half_adder_beh (</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">    input A, B,</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.qenlq1ibylcq" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">3.3 Half Adder – Structural Style</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">Cout = (A&amp;B) | (B&amp;Cin) | (A&amp;Cin)</span>` }} />
          <hr className={styles.divider} />
          id="h.n54rbeevwjwa" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">4.1 Full Adder – Dataflow</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">module full_adder_df (</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">    input A, B, Cin,</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">    output Sum, Cout</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">);</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.wrxcz47qu3by" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">4.2 Full Adder – Behavioral</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">module full_adder_beh (</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">    input A, B, Cin,</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">    output reg Sum, Cout</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">);</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.99tow8xlraln" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">4.3 Full Adder – Structural (Using Half Adders)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.awset360nj2n" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">5.1 4-bit Ripple Carry Adder – Behavioral</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.mfyv30bgwd9u" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">6.1 MUX – Dataflow</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.wsr9amdffsc6" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">6.2 MUX – Behavioral</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.gqc7qdhf40i8" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">6.3 MUX – Structural</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.vft2g1udicp9" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">7.1 Decoder – Behavioral</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.bgwazv3mzszm" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">CLASS 8 SUMMARY</span>` }} />
          ...
          id="h.gxzzoe45h6nl" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">SEQUENTIAL CIRCUITS USING RTL (COMPLETE BEGINNER → INDUSTRY LEVEL)</span>` }} />
          <hr className={styles.divider} />
          id="h.645zqs8cjx2m" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">1. What is a Sequential Circuit?</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span>A </span><span class="c19">sequential circuit</span><span class="c1"> is a digital circuit where:</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.ths4iydznicg" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">2. Memory Element in RTL</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.doaoze9eao0o" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">3. Why Non-Blocking Assignment (&lt;=)?</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.1kz5d0hdmgqa" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">4. LATCH vs FLIP-FLOP (RTL VIEW)</span>` }} />
          <div className={styles.tableContainer}>
          ...
          <hr className={styles.divider} />
          id="h.cbsn3z4k2qsg" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">5. SR FLIP-FLOP (RTL)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.p901zeuhell8" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">6. D FLIP-FLOP (MOST IMPORTANT)</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.2toe1qe3jcfv" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">7. JK FLIP-FLOP</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.4pr7nxker4ow" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">8. T FLIP-FLOP</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.zdho7ehcj6l6" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">9. REGISTER (4-BIT)</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.gv5cf3tvtouh" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">10. SHIFT REGISTER</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.jkfkg4sijxpz" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">11. COUNTERS</span>` }} />
          <hr className={styles.divider} />
          id="h.42ktxoahj9j" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">11.1 UP COUNTER (4-BIT)</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">module up_counter (</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">    input clk,</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">    input rst,</span>` }} />
          <p className={styles.mathFormula} dangerouslySetInnerHTML={{ __html: `<span class="c0">    output reg $$ 3:0 $$ count</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.e37t61ddr08n" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">11.2 DOWN COUNTER</span>` }} />
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">count &lt;= count - 1;</span>` }} />
          <hr className={styles.divider} />
          id="h.6qjwtghlse2m" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">12. SYNCHRONOUS vs ASYNCHRONOUS RESET</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">always @(posedge clk or posedge rst)</span>` }} />
          <hr className={styles.divider} />
          id="h.bb6570cpz9b7" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">13. COMMON RTL INTERVIEW RULES</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.f97ulygud4kd" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">CLASS 9 COMPLETE</span>` }} />
          ...
          id="h.o9sljihxwii3" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">FINITE STATE MACHINES (FSM) + REAL RTL MINI PROJECTS</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.ckyeg4yifwxk" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">1. What is an FSM (Finite State Machine)?</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.hmaqu1ed0a7z" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">2. Types of FSM</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.pjrd6b3klhbd" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">3. FSM DESIGN FLOW (VERY IMPORTANT)</span>` }} />
          ...
          <hr className={styles.divider} />
          id="h.xrl30jhyza64" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">4. FSM EXAMPLE 1 – SIMPLE TOGGLE FSM</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.knc2xu28la08" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">5. FSM EXAMPLE 2 – SEQUENCE DETECTOR (101)</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.r4l91u18cto3" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">6. FSM EXAMPLE 3 – TRAFFIC LIGHT CONTROLLER</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.9lfypk7qxvhz" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">7. RTL MINI PROJECT 1 – HALF ADDER</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.9j4jm1yn8x6b" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">8. RTL MINI PROJECT 2 – FULL ADDER</span>` }} />
          ...
          <p className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c0">endmodule</span>` }} />
          <hr className={styles.divider} />
          id="h.hsd3p9px0de" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">9. Behavioral vs Structural vs Dataflow (RECAP)</span>` }} />
          <div className={styles.tableContainer}>
          ...
          <hr className={styles.divider} />
          id="h.4pah85notdaa" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c13">10. INDUSTRY CODING RULES (VERY IMPORTANT)</span>` }} />
