  ...
  try {
    ...
    return data.jobPostings.map((job) => {
      ...
      return {
        ...
        title: job.title,
        experience: job.title.toLowerCase().match(/(senior|principal|staff|lead)/) ? "Experienced" : job.title.toLowerCase().match(/(junior|graduate|college|entry|intern| i$|i )/) ? "Freshers" : "Mid-Level",
