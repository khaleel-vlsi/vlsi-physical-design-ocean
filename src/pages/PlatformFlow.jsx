...
const PlatformFlow = () => {
  ...
  const steps = [
    { id: 1, title: 'Recording Video Classes',  isPremium: false, link: '/test-videos',       desc: 'High-quality recorded classes covering complete Physical Design from Basic to Advanced.',                                                              tag: 'WATCH',       color: '#10B981', icon: <path strokeLinecap="round" strokeLinejoin="round" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /> },
    ...
    { id: 8, title: 'Quiz Test',                isPremium: false, link: '/test-quiz-modules',   desc: 'Topic-wise 30-question practice quizzes across 18 modules with instant evaluation and full solution reviews.', tag: 'PRACTICE',    color: '#A855F7', icon: <path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" /> },
