...
const Module8Content = () => {
  ...
  const headings = [
    { id: 'h.1kmubxsyvifs', text: 'PHYSICAL SYNTHESIS – INTRODUCTION (ZERO → HERO)' },
    { id: 'h.c5cg8iz9uizz', text: '1️⃣ What is Physical Synthesis? (Classroom Explanation)' },
    { id: 'h.wkxbyn8rzza7', text: '2️⃣ Why Physical Synthesis is Needed' },
    { id: 'h.up5bvek888nv', text: 'Question for Students:' },
    { id: 'h.zbktatk2qgr', text: '3️⃣ Real-Life Analogy (Very Important)' },
    { id: 'h.7w5kcm9k3fyd', text: '4️⃣ What Exactly Happens in Physical Synthesis?' },
    { id: 'h.8hd373ignvax', text: '5️⃣ Where Physical Synthesis Fits in the VLSI Flow' },
    { id: 'h.6mvm5lhe8co', text: '6️⃣ Industry Scenario (Real Engineer Life)' },
    { id: 'h.nikohsh82zba', text: '8️⃣ Key Takeaways (Must Remember)' },
    { id: 'h.f9968ev9hwfr', text: '9️⃣ Mini Conclusion (Lecture Ending)' },
    { id: 'h.11ln91vt4lik', text: '1️⃣ What is Physical Synthesis (Industry Definition)' },
    { id: 'h.kuzq20wt2kiw', text: '2️⃣ Why Logical Synthesis Is NOT Enough' },
    { id: 'h.4brgt8htv4j0', text: '3️⃣ What Problems Physical Synthesis Solves' },
    { id: 'h.iis3t4b0o9yd', text: '4️⃣ Logical vs Physical Synthesis (Real Silicon View)' },
    { id: 'h.lgoolrsfxbna', text: '5️⃣ Evolution of Synthesis (Why PS Was Introduced)' },
    { id: 'h.sfeivuva2l36', text: '6️⃣ Tools That Support Physical Synthesis' },
    { id: 'h.xx9iuz1zztmi', text: '7️⃣ Role of a Physical Synthesis Engineer' },
    { id: 'h.bgwbzmpfe29i', text: '9️⃣ Key Takeaways (Exam + Industry)' },
    { id: 'h.d473a8vco59o', text: 'Module 1 Conclusion (Lecture Style)' },
    { id: 'h.lfilbn5eelht', text: 'INPUTS REQUIRED FOR PHYSICAL SYNTHESIS' },
    { id: 'h.xkbiszl0odlk', text: '0️⃣ Why Inputs Matter in Physical Synthesis' },
    { id: 'h.57luxoezexgx', text: '1️⃣ Gate-Level Netlist' },
    { id: 'h.h7nw0goq997f', text: '2️⃣ Technology Libraries (Very Critical)' },
    { id: 'h.tqesdx81yvqk', text: '3️⃣ .lib – Timing & Power Library' },
    { id: 'h.hm7roxmkfnws', text: '4️⃣ .lef – Physical Library Information' },
    { id: 'h.69jirg5kbo0p', text: '5️⃣ Physical Constraints' },
    { id: 'h.s5h64mb86r5i', text: '6️⃣ Floorplan Information' },
    { id: 'h.y8fn49i30cv3', text: '7️⃣ Placement Blockages' },
    { id: 'h.7d37fywgviic', text: '8️⃣ Timing Constraints (.sdc)' },
    { id: 'h.8h5i4wl0i5ih', text: '9️⃣ Power Intent (UPF / CPF – Intro Level)' },
    { id: 'h.r1fpjes3oy1g', text: '🔹 Intro-Level Note (Student View)' },
    { id: 'h.e28z4j317pvp', text: '🔟 Parasitic Information (Early Estimation)' },
    { id: 'h.hivi19r7261y', text: '1️⃣1️⃣ How All Inputs Work Together (Big Picture)' },
    { id: 'h.sgovzyloyle0', text: 'Module 2 Conclusion (Lecture Style)' },
    { id: 'h.4zyfa39uq6om', text: 'PHYSICAL AWARENESS CONCEPTS' },
    { id: 'h.q7yq80thxdbd', text: '0️⃣ Why This Module Is CRITICAL' },
    { id: 'h.tmw8x9jb7khl', text: '1️⃣ What is Physical Awareness?' },
    { id: 'h.sxkut9ldfjrk', text: '2️⃣ Cell Delay vs Wire Delay' },
    { id: 'h.6g3jl2gyfc18', text: '3️⃣ Why Interconnect Dominates Timing' },
    { id: 'h.2munf4vzg8hr', text: '4️⃣ RC Delay Basics (Must Know)' },
    { id: 'h.tm0p0l8c7x98', text: '5️⃣ Congestion Awareness' },
    { id: 'h.9dmb3bpda8sy', text: '6️⃣ Placement-Driven Optimization' },
    { id: 'h.q2szqnuv3eks', text: '7️⃣ Early Routing Estimation' },
    { id: 'h.uqjm1q8v1yj6', text: 'Module 3 Conclusion' },
    { id: 'h.8qvpity2l4ho', text: '📘 MODULE 4' },
    { id: 'h.4wvejbh67uzo', text: 'FLOORPLAN AWARENESS IN PHYSICAL SYNTHESIS' },
    { id: 'h.3ejwqi6yq7nb', text: '0️⃣ Why Floorplan Awareness Exists' },
    { id: 'h.1wwcvz983m8y', text: '1️⃣ What is a Floorplan?' },
    { id: 'h.95qcj1dztrnu', text: '2️⃣ Die Area vs Core Area' },
    { id: 'h.792uj1k4zdky', text: '3️⃣ Aspect Ratio' },
    { id: 'h.ox2fgfrfry8f', text: '4️⃣ Utilization' },
    { id: 'h.opkm8vszi54', text: '5️⃣ IO Placement (Overview Level)' },
    { id: 'h.84envzqn37uf', text: '6️⃣ Macro Awareness (SRAM, IP Blocks)' },
    { id: 'h.y6pqt07440g6', text: '7️⃣ Why Physical Synthesis MUST Know Floorplan' },
    { id: 'h.7j6eyfgxofkk', text: 'Module 4 Conclusion' },
    { id: 'h.h4u9unhdy3m', text: 'PHYSICAL SYNTHESIS FLOW (STEP-BY-STEP)' },
    { id: 'h.eb7ihy4sz8', text: '0️⃣ Why This Module Matters' },
    { id: 'h.l0hp56ghxesq', text: '1️⃣ Translation (Netlist + Physical Data)' },
    { id: 'h.c4wx78oyhlx2', text: '2️⃣ Initial Placement Estimation' },
    { id: 'h.x47aihtbbhh4', text: '3️⃣ Timing Analysis with Estimated RC' },
    { id: 'h.sw1x9jql9gzk', text: '4️⃣ Optimization Loop (Heart of PS)' },
    { id: 'h.co89sad75iou', text: '5️⃣ Re-Placement' },
    { id: 'h.dsn1sqvaoz5u', text: '6️⃣ Buffer Insertion' },
    { id: 'h.ma1ff0ot7pmo', text: '7️⃣ Gate Sizing' },
    { id: 'h.9kfw8paj96k6', text: '8️⃣ Logic Restructuring' },
    { id: 'h.jnwtkuo5otp8', text: '9️⃣ Timing Convergence' },
    { id: 'h.b5s6qdiib60d', text: 'Module 5 Conclusion' },
    { id: 'h.fzroygu23n98', text: '📘 MODULE 6' },
    { id: 'h.y655nn81wj0i', text: 'OPTIMIZATION TECHNIQUES IN PHYSICAL SYNTHESIS' },
    { id: 'h.1wje8ejb1vwu', text: '0️⃣ Big Picture' },
    { id: 'h.jxt8b7qop2k', text: '1️⃣ Gate Sizing' },
    { id: 'h.sy9ji8foge0', text: '2️⃣ Buffer Insertion' },
    { id: 'h.4xtvbdriu0ad', text: '3️⃣ Buffer Relocation' },
    { id: 'h.4rl63ubvxtp7', text: '4️⃣ Path Restructuring' },
    { id: 'h.63nu2k34kup6', text: '5️⃣ Cell Swapping' },
    { id: 'h.jf4cvkiorbza', text: '6️⃣ Delay vs Power Trade-offs' },
    { id: 'h.haz1dc6ofwea', text: '7️⃣ Area Recovery' },
    { id: 'h.r7kwhweqpzjc', text: '8️⃣ Physical Path Optimization' },
    { id: 'h.hzntx0lgn20l', text: 'Module 6 Conclusion' },
    { id: 'h.812x1wbcyrjb', text: 'TIMING CLOSURE IN PHYSICAL SYNTHESIS' },
    { id: 'h.d94gqu4cfmrr', text: '0️⃣ What is Timing Closure?' },
    { id: 'h.q2o6q38m4q7v', text: '1️⃣ Setup Timing Issues' },
    { id: 'h.1g8w2dssv3i9', text: '2️⃣ Hold Timing Issues' },
    { id: 'h.vhslklez6av5', text: '3️⃣ Why Timing Changes After Placement' },
    { id: 'h.il2co8vbelxq', text: '4️⃣ Path-Based Optimization' },
    { id: 'h.wprbgkl5bvu6', text: '5️⃣ WNS, TNS, FEP' },
    { id: 'h.ftjjk5dvguel', text: '6️⃣ Timing Corners' },
    { id: 'h.ldz7w29q0sye', text: '7️⃣ MCMM (Multi-Corner Multi-Mode – Intro)' },
    { id: 'h.3tknm5tp522x', text: 'Module 7 Conclusion' },
    { id: 'h.4ihbgzckuomu', text: '0️⃣ Why Clock Is Called “King”' },
    { id: 'h.42f08mjawhhl', text: '1️⃣ Clock Latency' },
    { id: 'h.uzc6njbw6lgz', text: '2️⃣ Clock Skew' },
    { id: 'h.g8epvllcxitc', text: '3️⃣ Clock Uncertainty' },
    { id: 'h.nvyas23x8lmi', text: '4️⃣ Clock Tree Estimation (Pre-CTS)' },
    { id: 'h.l4jb6dtmuey9', text: '5️⃣ Why Physical Synthesis Cares About Clock' },
    { id: 'h.yw7uxh7sfobh', text: '6️⃣ CTS vs Physical Synthesis Responsibilities' },
    { id: 'h.zklfeqhv2t1', text: '7️⃣ Pre-CTS Optimization' },
    { id: 'h.4ghrzld7cw00', text: 'Module 8 Conclusion' },
    { id: 'h.9kqt8k8fzolx', text: '📘 MODULE 9' },
    { id: 'h.mriz7t96x9mk', text: 'CONGESTION & ROUTABILITY AWARE PHYSICAL SYNTHESIS' },
    { id: 'h.dm7niivrrmmw', text: '0️⃣ Why Congestion Is a BIG Problem' },
    { id: 'h.84ugkggztwvn', text: '1️⃣ What is Congestion?' },
    { id: 'h.nux8oo4udxt', text: '2️⃣ Why Congestion Happens' },
    { id: 'h.btc00vjzdtuh', text: '3️⃣ Congestion Hotspots' },
    { id: 'h.8ur9cl2akd8', text: '4️⃣ Impact of Congestion' },
    { id: 'h.8m879ktlhcpa', text: '5️⃣ Congestion-Aware Optimization' },
    { id: 'h.we05t7b1ymr7', text: '6️⃣ Wire Spreading' },
    { id: 'h.tc1enqpmaonx', text: '7️⃣ Cell Spreading' },
    { id: 'h.5z99q3cky2r3', text: 'Module 9 Conclusion' },
    { id: 'h.nvad0jk2luds', text: '📘 MODULE 10' },
    { id: 'h.nrwaaxmjd8mp', text: 'POWER AWARENESS IN PHYSICAL SYNTHESIS' },
    { id: 'h.lfxe0zcrrl28', text: '0️⃣ Why Power Matters' },
    { id: 'h.a6420yfdub4m', text: '1️⃣ Dynamic Power' },
    { id: 'h.knus74hmjt58', text: '2️⃣ Leakage Power' },
    { id: 'h.h4rky8qznpz1', text: '3️⃣ Switching Activity' },
    { id: 'h.vl3upuvkpe46', text: '4️⃣ Power vs Timing Trade-offs' },
    { id: 'h.57r16ar81jfb', text: '5️⃣ Early Power Estimation' },
    { id: 'h.1z78iwfj8wgq', text: '6️⃣ Low-Power Optimizations (Intro)' },
    { id: 'h.qsm7u7pw5hbx', text: 'Module 10 Conclusion' },
    { id: 'h.mdc3lxkutk08', text: '📘 MODULE 11' },
    { id: 'h.6nzj5miokj78', text: 'PHYSICAL SYNTHESIS vs PLACE & ROUTE' },
    { id: 'h.z9cw9c1801ug', text: '0️⃣ Why This Confusion Exists' },
    { id: 'h.nunxuv2aqmxa', text: '1️⃣ What Physical Synthesis Does (CLEARLY)' },
    { id: 'h.jh4ctow533h7', text: '2️⃣ What Place & Route Does (CLEARLY)' },
    { id: 'h.8wadtjurv5bw', text: '3️⃣ Where Physical Synthesis Stops' },
    { id: 'h.o2v1vo16qidy', text: '4️⃣ Why PS Improves P&R Results' },
    { id: 'h.kc417v3f4tbs', text: '5️⃣ Handoff Between PS and P&R' },
    { id: 'h.58p5dbn9pmke', text: 'Module 11 Conclusion' },
    { id: 'h.lgea028kws5x', text: '📘 MODULE 12' },
    { id: 'h.2z6kuny2jcxi', text: 'OUTPUTS OF PHYSICAL SYNTHESIS' },
    { id: 'h.tpwxz7thhjqm', text: '0️⃣ Why Outputs Matter' },
    { id: 'h.q6naky1fhbcq', text: '1️⃣ Optimized Gate-Level Netlist' },
    { id: 'h.meztaivnp59', text: '2️⃣ Updated Constraints (SDC)' },
    { id: 'h.l8bwiiga5xva', text: '3️⃣ Timing Reports' },
    { id: 'h.8mznth802dp0', text: '4️⃣ Power Reports' },
    { id: 'h.bbizc9fnq9zi', text: '5️⃣ Area Reports' },
    { id: 'h.g1yvoiahi9gg', text: '6️⃣ Physical Guidance Files' },
    { id: 'h.1epsgw7u05gp', text: 'Module 12 Conclusion' },
    { id: 'h.z2lqb7eb1egw', text: 'MODULE 13' },
    { id: 'h.dfn1omk7j8ln', text: 'INDUSTRIAL PHYSICAL SYNTHESIS FLOW' },
    { id: 'h.2cmlgxvcq6bt', text: '0️⃣ This Is NOT Linear – This Is Iterative' },
    { id: 'h.ftxkql82ftde', text: '1️⃣ End-to-End Industrial Flow' },
    { id: 'h.e8bagao6xnc5', text: '2️⃣ Script-Driven Flow' },
    { id: 'h.tkt6ehcwyfkm', text: '3️⃣ Iterations with P&R Team' },
    { id: 'h.cnv40qvxzenp', text: '4️⃣ ECO Loops (Engineering Change Order)' },
    { id: 'h.68dsrhmqcq5k', text: '5️⃣ Signoff Mindset' },
    { id: 'h.rzus4rj6im7k', text: 'Module 13 Conclusion' },
    { id: 'h.fqgjv35wxslg', text: 'PHYSICAL SYNTHESIS COMPLETE (ZERO → HERO)' },
    { id: 'h.cju86ftojqpx', text: '1️⃣ Required Tool Knowledge (What You MUST Know)' },
    { id: 'h.ibxh4ns34vzn', text: '2️⃣ Timing Debugging Mindset (MOST IMPORTANT SKILL)' },
    { id: 'h.bqzio0eorqaf', text: '3️⃣ Communication with P&R Team' },
    { id: 'h.fkxab7vp0gic', text: '4️⃣ Common Mistakes by Freshers' },
    { id: 'h.q88kqrv3eihe', text: '5️⃣ Interview Expectations (REAL)' },
    { id: 'h.njxv4k86sxyt', text: 'Module 14 Conclusion' },
    { id: 'h.ntahlogb329', text: 'COMMON MYTHS & MISTAKES' },
    { id: 'h.1o3l2qe2l634', text: 'Myth 1: “Physical Synthesis replaces P&R”' },
    { id: 'h.gdiscddvu9z0', text: 'Myth 2: “Only timing matters”' },
    { id: 'h.7xtpqjamp8hp', text: 'Myth 3: “RTL coding doesn’t matter”' },
    { id: 'h.fpwql0lu2w4f', text: 'Myth 4: “More optimization is always better”' },
    { id: 'h.nyba6otys0c2', text: 'Module 15 Conclusion' },
    { id: 'h.9km1s3ykyj6f', text: 'MODULE 16' },
    { id: 'h.wmz7xmgvye1j', text: 'ZERO → HERO SUMMARY' },
    { id: 'h.a6nnd31z35hi', text: '1️⃣ What the Student Knows Now' },
    { id: 'h.jxi0imz8re9m', text: '2️⃣ How Physical Synthesis Helps Silicon Success' },
    { id: 'h.5w9io3oycb2q', text: '3️⃣ Next Step: Place & Route' },
  ];
    ...
    <div className={styles.moduleLayout}>
      ...
      <div className={styles.mainContent}>
        <div className={styles.contentCard}>
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span>But </span><span class="c13">silicon does not work on paper</span><span class="c1">.</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">In real silicon:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span>Gates are placed </span><span class="c14 c13">physically<br></span></li><li class="c3 li-bullet-0"><span>Wires have </span><span class="c14 c13">length, resistance, capacitance<br></span></li><li class="c3 li-bullet-0"><span class="c1">Clock does not reach all flops at the same time<br></span></li><li class="c3 li-bullet-0"><span class="c1">Power, congestion, noise start affecting timing<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span> Logical synthesis </span><span class="c13">assumes ideal wires<br></span><span>  Physical world </span><span class="c14 c13">does NOT have ideal wires</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span>This gap created a </span><span class="c13">huge problem</span><span class="c1"> in the industry.</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span>So engineers introduced </span><span class="c14 c13">Physical Synthesis</span>` }} />
          <h3 id="h.terrb2a3oba6" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Definition (Lecture Style)</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c14 c13">Physical Synthesis is the process of optimizing the design using physical information (placement, wire length, congestion, and timing) to meet power, performance, and area goals before final place-and-route.</span>` }} />
          ...
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span>Does not know </span><span class="c14 c13">where gates will be placed<br></span></li><li class="c3 li-bullet-0"><span>Does not know </span><span class="c14 c13">actual wire length<br></span></li><li class="c3 li-bullet-0"><span>Uses </span><span class="c14 c13">estimated wire delay<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">After placement:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Wires become long<br></span></li><li class="c3 li-bullet-0"><span class="c1">Timing breaks<br></span></li><li class="c3 li-bullet-0"><span class="c1">Congestion increases<br></span></li><li class="c3 li-bullet-0"><span class="c1">Power increases<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">So industry realized:</span>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">On paper:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Bedroom to kitchen looks close<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">In reality:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Bedroom is on 10th floor<br></span></li><li class="c3 li-bullet-0"><span class="c1">Kitchen is in another building<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">You now need:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Longer stairs<br></span></li><li class="c3 li-bullet-0"><span class="c1">Elevators<br></span></li><li class="c3 li-bullet-0"><span class="c1">More power<br></span></li><li class="c3 li-bullet-0"><span class="c1">More time<br></span></li>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c17 c12">Logical Synthesis</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c17 c12"> ↓</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c17 c12">Physical Synthesis  ← YOU ARE HERE</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c17 c12"> ↓</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c17 c12">Placement</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c12 c17"> ↓</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c17 c12">Clock Tree Synthesis (CTS)</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c17 c12"> ↓</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c17 c12">Routing</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c17 c12"> ↓</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c17 c12">Signoff</span>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">If you wait till routing:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Too many ECOs<br></span></li><li class="c3 li-bullet-0"><span class="c1">Schedule slips<br></span></li><li class="c3 li-bullet-0"><span class="c1">Manager unhappy <br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">But with Physical Synthesis:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Timing improves early<br></span></li><li class="c3 li-bullet-0"><span class="c1">Fewer ECOs<br></span></li><li class="c3 li-bullet-0"><span class="c1">Cleaner layout<br></span></li><li class="c3 li-bullet-0"><span class="c1">Better power<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span> Industry </span><span class="c14 c13">always prefers early fixes</span>` }} />
          <hr className={styles.divider} />
          ...
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1"> Beginner engineers<br></span></li><li class="c3 li-bullet-0"><span class="c1"> Industry-ready engineers</span></li>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span>Now let us break this into </span><span class="c13">student-friendly meaning</span><span class="c1">:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span>Logical synthesis thinks </span><span class="c14 c13">“What logic is needed?”<br></span></li><li class="c3 li-bullet-0"><span>Physical synthesis thinks </span><span class="c14 c13">“Where will this logic sit physically on silicon?”<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span> Physical synthesis </span><span class="c13">changes logic decisions</span><span class="c1"> based on:</span>` }} />
          ...
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Zero wire length<br></span></li><li class="c3 li-bullet-0"><span class="c1">No congestion<br></span></li><li class="c3 li-bullet-0"><span class="c1">Perfect clock arrival<br></span></li><li class="c3 li-bullet-0"><span class="c1">Ideal environment<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Example:</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c17 c12">Flop → Gate → Gate → Flop</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Logical synthesis says:</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">“Timing is clean ✔”</span>` }} />
          <h3 id="h.7jjvct8v6enn" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 What Happens in Real Silicon</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">In real silicon:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Gates are far apart<br></span></li><li class="c3 li-bullet-0"><span class="c1">Wires are long<br></span></li><li class="c3 li-bullet-0"><span class="c1">Clock skew exists<br></span></li><li class="c3 li-bullet-0"><span class="c1">Routing adds delay<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Suddenly:</span>` }} />
          ...
          <div className={styles.tableContainer}>
            <table className={styles.contentTable} dangerouslySetInnerHTML={{ __html: `<tbody><tr class="c27"><td class="c18" colspan="1" rowspan="1"><p class="c16"><span class="c13">Problem</span></p></td><td class="c23" colspan="1" rowspan="1"><p class="c16"><span class="c13">Why it Happens</span></p></td></tr><tr class="c27"><td class="c18" colspan="1" rowspan="1"><p class="c9"><span class="c1">Timing failure</span></p></td><td class="c23" colspan="1" rowspan="1"><p class="c9"><span class="c1">Long wires after placement</span></p></td></tr><tr class="c27"><td class="c18" colspan="1" rowspan="1"><p class="c9"><span class="c1">Congestion</span></p></td><td class="c23" colspan="1" rowspan="1"><p class="c9"><span class="c1">Too many cells in one region</span></p></td></tr><tr class="c27"><td class="c18" colspan="1" rowspan="1"><p class="c9"><span class="c1">Excessive buffering</span></p></td><td class="c23" colspan="1" rowspan="1"><p class="c9"><span class="c1">Fixes applied too late</span></p></td></tr><tr class="c27"><td class="c18" colspan="1" rowspan="1"><p class="c9"><span class="c1">High power</span></p></td><td class="c23" colspan="1" rowspan="1"><p class="c9"><span class="c1">Over-buffering</span></p></td></tr><tr class="c27"><td class="c18" colspan="1" rowspan="1"><p class="c9"><span class="c1">Late ECOs</span></p></td><td class="c23" colspan="1" rowspan="1"><p class="c9"><span class="c1">Fixing problems at routing stage</span></p></td></tr></tbody>` }} />
          </div>
          <hr className={styles.divider} />
          <h3 id="h.vf7ndqk7gza3" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7"> Problems Solved by Physical Synthesis</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Physical synthesis solves:</span>` }} />
          ...
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span>Uses </span><span class="c14 c13">placement-aware estimation<br></span></li><li class="c3 li-bullet-0"><span class="c1">Considers real distances<br></span></li><li class="c3 li-bullet-0"><span class="c1">Knows congestion regions<br></span></li><li class="c3 li-bullet-0"><span>Timing is </span><span class="c14 c13">closer to silicon reality<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.yystn8c4vjky" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7"> Comparison Table (Student Friendly)</span>` }} />
          <div className={styles.tableContainer}>
          ...
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Wire delay &gt; gate delay<br></span></li><li class="c3 li-bullet-0"><span class="c1">Congestion dominates timing<br></span></li><li class="c3 li-bullet-0"><span class="c1">Clock skew is critical<br></span></li><li class="c3 li-bullet-0"><span class="c1">Power is extremely sensitive<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span> Logical synthesis </span><span class="c14 c13">started failing consistently</span>` }} />
          <h3 id="h.rw81mlx6gkmq" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7"> Industry Response</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Industry introduced:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Placement-aware synthesis<br></span></li><li class="c3 li-bullet-0"><span class="c1">Physical estimation early<br></span></li><li class="c3 li-bullet-0"><span class="c1">Physical synthesis engines<br></span></li>` }} />
          ...
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Early physical estimation is needed<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.w340rgmqc7fp" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7"> 2. Synopsys Fusion Compiler</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Full RTL → GDS flow<br></span></li><li class="c3 li-bullet-0"><span class="c1">Unified synthesis + place + route<br></span></li><li class="c3 li-bullet-0"><span class="c1">Strong physical synthesis engine<br></span></li><li class="c3 li-bullet-0"><span class="c1">Industry-standard for advanced nodes<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Used when:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Tight timing<br></span></li><li class="c3 li-bullet-0"><span class="c1">Advanced technology nodes<br></span></li><li class="c3 li-bullet-0"><span class="c1">Large SoCs<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.i2trca26xw17" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7"> 3. Cadence Genus (Physical Mode)</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Logical synthesis + physical guidance<br></span></li><li class="c3 li-bullet-0"><span class="c1">Works with Innovus<br></span></li><li class="c3 li-bullet-0"><span class="c1">Physical-aware optimization<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Used when:</span>` }} />
          ...
          <h3 id="h.f5rif23pbcrq" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7"> Not Just Running Commands</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">A physical synthesis engineer must:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Understand timing deeply<br></span></li><li class="c3 li-bullet-0"><span class="c1">Understand placement impact<br></span></li><li class="c3 li-bullet-0"><span class="c1">Know when to restructure logic<br></span></li><li class="c3 li-bullet-0"><span class="c1">Balance power, performance, and area<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span> This role requires </span><span class="c13">thinking</span><span class="c1">, not just scripting.</span>` }} />
          <hr className={styles.divider} />
          <div className={styles.imageContainer}>
          ...
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Missing <br></span></li><li class="c3 li-bullet-0"><span class="c1">Wrong <br></span></li><li class="c3 li-bullet-0"><span class="c1">Incomplete <br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Then:</span>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Example (conceptual):</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c17 c12">U1 AND2_X1</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c17 c12">U2 DFF_X1</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c17 c12">U3 INV_X2</span>` }} />
          <hr className={styles.divider} />
          <h3 id="h.btu4hqi8dklf" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Why Physical Synthesis Needs It</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Physical synthesis:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Does NOT work on RTL directly (mostly)<br></span></li><li class="c3 li-bullet-0"><span class="c1">Needs exact gates that will be placed<br></span></li><li class="c3 li-bullet-0"><span>Optimizes </span><span class="c14 c13">gate structure + placement impact<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1"> It answers:</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">“Given these gates, how do I place and optimize them physically?”</span>` }} />
          <hr className={styles.divider} />
          <h3 id="h.l2oyf0ik9gy2" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Real-Life Analogy</span>` }} />
          ...
          <hr className={styles.divider} />
          <h3 id="h.ubw943dowr" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 What Information It Contains</span>` }} />
          <h4 id="h.jhszlgb9td1v" className={styles.h4} dangerouslySetInnerHTML={{ __html: `<span class="c14 c13"> Timing Information</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Cell delay<br></span></li><li class="c3 li-bullet-0"><span class="c1">Setup time<br></span></li><li class="c3 li-bullet-0"><span class="c1">Hold time<br></span></li><li class="c3 li-bullet-0"><span class="c1">Clock-to-Q<br></span></li><li class="c3 li-bullet-0"><span class="c1">Transition delays<br></span></li>` }} />
          <h4 id="h.hw8wsmilokg1" className={styles.h4} dangerouslySetInnerHTML={{ __html: `<span class="c14 c13"> Power Information</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Internal power<br></span></li><li class="c3 li-bullet-0"><span class="c1">Switching power<br></span></li><li class="c3 li-bullet-0"><span class="c1">Leakage power<br></span></li>` }} />
          <h4 id="h.mdp3aji4pf1m" className={styles.h4} dangerouslySetInnerHTML={{ __html: `<span class="c14 c13"> Logical Info</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Boolean function<br></span></li><li class="c3 li-bullet-0"><span class="c1">Pin direction<br></span></li><li class="c3 li-bullet-0"><span class="c1">Timing arcs<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.5pj2yhp6quzb" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Why Physical Synthesis Needs .lib</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span>Physical synthesis uses </span><span class="c12">.lib</span><span class="c1"> to:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span>Calculate </span><span class="c14 c13">realistic timing<br></span></li><li class="c3 li-bullet-0"><span class="c1">Choose faster or smaller cells<br></span></li><li class="c3 li-bullet-0"><span class="c1">Balance power vs performance<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Example:</span>` }} />
          ...
          <hr className={styles.divider} />
          <h3 id="h.omipkarhnyug" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 What Information LEF Contains</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Cell width &amp; height<br></span></li><li class="c3 li-bullet-0"><span class="c1">Pin locations<br></span></li><li class="c3 li-bullet-0"><span class="c1">Metal layers<br></span></li><li class="c3 li-bullet-0"><span class="c1">Routing tracks<br></span></li><li class="c3 li-bullet-0"><span class="c1">Blockages<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.91vh1sb16y30" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Why Physical Synthesis Needs LEF</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Physical synthesis needs LEF to:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Estimate placement<br></span></li><li class="c3 li-bullet-0"><span class="c1">Estimate wire length<br></span></li><li class="c3 li-bullet-0"><span class="c1">Detect congestion<br></span></li><li class="c3 li-bullet-0"><span class="c1">Understand routing feasibility<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span> Timing depends on </span><span class="c13">distance</span><span class="c1">, not just logic.</span>` }} />
          <hr className={styles.divider} />
          <h3 id="h.94qvwkgawfib" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Important Note (Very Industry-Relevant)</span>` }} />
          ...
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Where things are allowed<br></span></li><li class="c3 li-bullet-0"><span class="c1">Where things are forbidden<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.z1fuqtv9m41q" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Types of Physical Constraints</span>` }} />
          <h4 id="h.4yiq2oqekyk5" className={styles.h4} dangerouslySetInnerHTML={{ __html: `<span class="c14 c13">✔ Core area</span>` }} />
          <h4 id="h.kqpiuul91kcb" className={styles.h4} dangerouslySetInnerHTML={{ __html: `<span class="c14 c13">✔ Keep-out regions</span>` }} />
          <h4 id="h.vc2mvne0ki3a" className={styles.h4} dangerouslySetInnerHTML={{ __html: `<span class="c14 c13">✔ Placement restrictions</span>` }} />
          <h4 id="h.a6m5irgc0s7m" className={styles.h4} dangerouslySetInnerHTML={{ __html: `<span class="c14 c13">✔ Macro boundaries</span>` }} />
          ...
          <hr className={styles.divider} />
          <h3 id="h.r256uu7rbo2v" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Why Physical Synthesis Needs Floorplan</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Physical synthesis uses floorplan to:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Understand distance between blocks<br></span></li><li class="c3 li-bullet-0"><span class="c1">Predict routing paths<br></span></li><li class="c3 li-bullet-0"><span class="c1">Perform placement-aware optimization<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Example:</span>` }} />
          ...
          <hr className={styles.divider} />
          <h3 id="h.yuffm2w8yxk2" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Why They Matter in Physical Synthesis</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Blockages cause:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Congestion<br></span></li><li class="c3 li-bullet-0"><span class="c1">Detours in routing<br></span></li><li class="c3 li-bullet-0"><span class="c1">Unexpected timing degradation<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Physical synthesis:</span>` }} />
          ...
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Clock definitions<br></span></li><li class="c3 li-bullet-0"><span class="c1">Input delays<br></span></li><li class="c3 li-bullet-0"><span class="c1">Output delays<br></span></li><li class="c3 li-bullet-0"><span class="c1">False paths<br></span></li><li class="c3 li-bullet-0"><span class="c1">Multicycle paths<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.6uz6fqtpe50n" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Why Physical Synthesis Needs SDC</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Physical synthesis optimizes:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Only what is constrained<br></span></li><li class="c3 li-bullet-0"><span class="c1">Only what matters for timing<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">No SDC → Tool does NOT know:</span>` }} />
          ...
          <hr className={styles.divider} />
          <h3 id="h.n0o87p559cw1" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Why Physical Synthesis Needs It</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Physical synthesis must:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Place power cells correctly<br></span></li><li class="c3 li-bullet-0"><span class="c1">Preserve isolation logic<br></span></li><li class="c3 li-bullet-0"><span class="c1">Avoid illegal optimization<br></span></li>` }} />
          ...
          <hr className={styles.divider} />
          <h3 id="h.hlu6gvtdzmvm" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Why Physical Synthesis Needs Early Parasitics</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Even before routing:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Tool estimates RC values<br></span></li><li class="c3 li-bullet-0"><span class="c1">Predicts timing more accurately<br></span></li><li class="c3 li-bullet-0"><span class="c1">Reduces surprises later<br></span></li>` }} />
          ...
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Questions inputs<br></span></li><li class="c3 li-bullet-0"><span class="c1">Validates inputs<br></span></li><li class="c3 li-bullet-0"><span class="c1">Understands why each input exists</span></li>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span> </span><span class="c13">Physical awareness</span><span class="c1"> is the reason:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Logical synthesis timing looks good <br></span></li><li class="c3 li-bullet-0"><span class="c1">Post-route timing fails <br></span></li>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">In other words:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Tool does NOT assume gates are next to each other<br></span></li><li class="c3 li-bullet-0"><span>Tool predicts </span><span class="c14 c13">where gates will be placed<br></span></li><li class="c3 li-bullet-0"><span>Tool estimates </span><span class="c14 c13">how long wires will be<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.1evj1gl8syb6" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Logical vs Physical Thinking</span>` }} />
          <div className={styles.tableContainer}>
            <table className={styles.contentTable} dangerouslySetInnerHTML={{ __html: `<tbody><tr class="c27"><td class="c21" colspan="1" rowspan="1"><p class="c16"><span class="c13">Logical Thinking</span></p></td><td class="c35" colspan="1" rowspan="1"><p class="c16"><span class="c13">Physical Thinking</span></p></td></tr><tr class="c27"><td class="c21" colspan="1" rowspan="1"><p class="c9"><span class="c1">Zero wire delay</span></p></td><td class="c35" colspan="1" rowspan="1"><p class="c9"><span class="c1">Real wire delay</span></p></td></tr><tr class="c27"><td class="c21" colspan="1" rowspan="1"><p class="c9"><span class="c1">Ideal placement</span></p></td><td class="c35" colspan="1" rowspan="1"><p class="c9"><span class="c1">Congested placement</span></p></td></tr><tr class="c27"><td class="c21" colspan="1" rowspan="1"><p class="c9"><span class="c1">Gates are free</span></p></td><td class="c35" colspan="1" rowspan="1"><p class="c9"><span class="c1">Gates occupy area</span></p></td></tr></tbody>` }} />
          </div>
          ...
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c8 c24 li-bullet-0"><span class="c1">Input slew<br></span></li><li class="c8 c24 li-bullet-0"><span class="c1">Output load<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Example:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">INV delay = 10 ps<br></span></li><li class="c3 li-bullet-0"><span class="c1">AND delay = 25 ps<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.1qe6n0dlmpid" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 What is Wire Delay?</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Wire delay is:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Delay due to metal interconnect<br></span></li><li class="c3 li-bullet-0"><span class="c1">Depends on:<br></span></li>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c8 c24 li-bullet-0"><span class="c1">Wire length<br></span></li><li class="c8 c24 li-bullet-0"><span class="c1">Metal layer<br></span></li><li class="c8 c24 li-bullet-0"><span class="c1">Resistance (R)<br></span></li><li class="c8 c24 li-bullet-0"><span class="c1">Capacitance (C)<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.ynit83x9uynk" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Reality Check (Very Important)</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span>In </span><span class="c13">advanced nodes</span><span class="c1"> (28nm, 14nm, 7nm):</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c14 c13">Wire delay &gt; Cell delay</span>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c14 c13">Modern technologies (28nm and below):</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Long global wires<br></span></li><li class="c3 li-bullet-0"><span class="c1">Thin metal<br></span></li><li class="c3 li-bullet-0"><span class="c1">High resistance<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1"> Result:</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c14 c13">Interconnect delay dominates timing</span>` }} />
          <hr className={styles.divider} />
          <h3 id="h.ezpwb7npstep" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Real Example</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Path delay breakdown:</span>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Where:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">R = resistance of wire<br></span></li><li class="c3 li-bullet-0"><span class="c1">C = capacitance of wire<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.kj8bkdkqsdnm" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Why RC Increases</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Longer wire → more R<br></span></li><li class="c3 li-bullet-0"><span class="c1">Wider coupling → more C<br></span></li><li class="c3 li-bullet-0"><span class="c1">Congested routing → detours → more length<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.gxeg8iemr286" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Key Student Insight</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c14 c13">Every extra micron of wire adds delay</span>` }} />
          ...
          <hr className={styles.divider} />
          <h3 id="h.nh76zvx4fg1s" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Why Congestion is Dangerous</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Congestion causes:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Longer routing paths<br></span></li><li class="c3 li-bullet-0"><span class="c1">Higher RC delay<br></span></li><li class="c3 li-bullet-0"><span class="c1">DRC violations<br></span></li><li class="c3 li-bullet-0"><span class="c1">Timing degradation<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.dkkisw9m7xnz" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Physical Synthesis Role</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Physical synthesis:</span>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Physical synthesis does:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c14 c13">Place first (roughly)<br></span></li><li class="c3 li-bullet-0"><span class="c1">Optimize based on placement<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.jlk1i9aouwvl" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Example</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">If two flops are far apart:</span>` }} />
          ...
          <hr className={styles.divider} />
          <h3 id="h.mjiokxzhgoip" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Why This Is Powerful</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Early routing allows:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Early timing fixes<br></span></li><li class="c3 li-bullet-0"><span class="c1">Fewer surprises in P&amp;R<br></span></li><li class="c3 li-bullet-0"><span class="c1">Faster convergence<br></span></li>` }} />
          <hr className={styles.divider} />
          <div className={styles.imageContainer}>
          ...
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Thinks in microns<br></span></li><li class="c3 li-bullet-0"><span class="c1">Thinks in RC<br></span></li><li class="c3 li-bullet-0"><span class="c1">Thinks in congestion<br></span></li>` }} />
          <hr className={styles.divider} />
          <hr className={styles.divider} />
          <h1 id="h.8qvpity2l4ho" className={styles.h1} dangerouslySetInnerHTML={{ __html: `<span class="c5">📘 MODULE 4</span>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c14 c13">Because timing is physical.</span>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Common values:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">1:1 (square)<br></span></li><li class="c3 li-bullet-0"><span class="c1">1.2:1<br></span></li><li class="c3 li-bullet-0"><span class="c1">2:1<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.3pddrdx5qauh" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Why Aspect Ratio Matters</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Bad aspect ratio causes:</span>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Example:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">70% utilization → good<br></span></li><li class="c3 li-bullet-0"><span class="c1">85% utilization → risky<br></span></li><li class="c3 li-bullet-0"><span class="c1">95% utilization → nightmare<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.6k5kc96hlark" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Why PS Cares</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">High utilization:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Less routing space<br></span></li><li class="c3 li-bullet-0"><span class="c1">More congestion<br></span></li><li class="c3 li-bullet-0"><span class="c1">Timing failures<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Physical synthesis may:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Spread logic<br></span></li><li class="c3 li-bullet-0"><span class="c1">Resize cells<br></span></li><li class="c3 li-bullet-0"><span class="c1">Reduce density<br></span></li>` }} />
          <hr className={styles.divider} />
          <AdUnit slotId="slot_module8content_mid1" />
          <h2 id="h.opkm8vszi54" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c2">5️⃣ IO Placement (Overview Level)</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">IOs define:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Entry and exit points of signals<br></span></li><li class="c3 li-bullet-0"><span class="c1">Distance to internal logic<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Poor IO placement:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Long wires<br></span></li><li class="c3 li-bullet-0"><span class="c1">Input/output timing issues<br></span></li>` }} />
          ...
          <hr className={styles.divider} />
          <h3 id="h.696barf163en" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Why Macros Matter</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Macros:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Block routing<br></span></li><li class="c3 li-bullet-0"><span class="c1">Create congestion<br></span></li><li class="c3 li-bullet-0"><span class="c1">Force detours<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Physical synthesis:</span>` }} />
          ...
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Realistic timing<br></span></li><li class="c3 li-bullet-0"><span class="c1">Better optimization<br></span></li><li class="c3 li-bullet-0"><span class="c1">Faster P&amp;R convergence<br></span></li>` }} />
          <hr className={styles.divider} />
          <div className={styles.imageContainer}>
          ...
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Gate-level netlist<br></span></li><li class="c3 li-bullet-0"><span class="c1">Timing libraries (.lib)<br></span></li><li class="c3 li-bullet-0"><span class="c1">Physical libraries (.lef)<br></span></li><li class="c3 li-bullet-0"><span class="c1">Constraints (.sdc)<br></span></li><li class="c3 li-bullet-0"><span class="c1">Floorplan info<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">And converts everything into:</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c14 c13">A physically-aware internal database</span>` }} />
          <hr className={styles.divider} />
          <h3 id="h.6mkvpdlmu858" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 What Happens Internally?</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span>Logical connections are mapped to </span><span class="c14 c13">physical cells<br></span></li><li class="c3 li-bullet-0"><span class="c1">Cells get:<br></span></li>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c8 c24 li-bullet-0"><span class="c1">Width<br></span></li><li class="c8 c24 li-bullet-0"><span class="c1">Height<br></span></li><li class="c8 c24 li-bullet-0"><span class="c1">Pin locations<br></span></li>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Nets are associated with:<br></span></li>` }} />
          ...
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Rough placement<br></span></li><li class="c3 li-bullet-0"><span class="c1">Timing-driven<br></span></li><li class="c3 li-bullet-0"><span class="c1">Congestion-aware<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.iyxbnwy6nibm" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 What the Tool Does</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Spreads standard cells in core<br></span></li><li class="c3 li-bullet-0"><span class="c1">Keeps connected logic close<br></span></li><li class="c3 li-bullet-0"><span class="c1">Respects macros and blockages<br></span></li><li class="c3 li-bullet-0"><span class="c1">Estimates wire lengths<br></span></li>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Physical synthesis assumes:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Real wires ✔️<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.sf827j5g5swy" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 What Happens Here</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Tool calculates:<br></span></li>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c8 c24 li-bullet-0"><span class="c1">Wire resistance<br></span></li><li class="c8 c24 li-bullet-0"><span class="c1">Wire capacitance<br></span></li>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">So placement must be updated.</span>` }} />
          <hr className={styles.divider} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Example:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">INV_X1 → INV_X4<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.j6812af6xbf7" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Trade-off</span>` }} />
          ...
          <hr className={styles.divider} />
          <h3 id="h.qtoymz65aitc" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 When Flow Stops</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Flow stops when:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Timing is met<br></span></li><li class="c3 li-bullet-0"><span class="c1">Power is acceptable<br></span></li><li class="c3 li-bullet-0"><span class="c1">Area is reasonable<br></span></li>` }} />
          <hr className={styles.divider} />
          <div className={styles.imageContainer}>
          ...
          <hr className={styles.divider} />
          <hr className={styles.divider} />
          <h1 id="h.fzroygu23n98" className={styles.h1} dangerouslySetInnerHTML={{ __html: `<span class="c5">📘 MODULE 6</span>` }} />
          ...
          <hr className={styles.divider} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c5">📘 MODULE 7</span>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Sum of all violations.</span>` }} />
          <h3 id="h.pgd7rjkmuzgj" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 FEP (Failing Endpoints)</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Number of endpoints failing timing.</span>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Physical synthesis must:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span>Close timing across </span><span class="c14 c13">all corners &amp; modes<br></span></li>` }} />
          <hr className={styles.divider} />
          <div className={styles.imageContainer}>
          ...
          <hr className={styles.divider} />
          <h3 id="h.xotbk6ozt1rg" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Two Types (Important)</span>` }} />
          <ol className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c14 c13">Source latency<br></span></li>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c8 c24 li-bullet-0"><span class="c1">Clock source → chip boundary<br></span></li>` }} />
          <ol className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c14 c13">Network latency<br></span></li>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c8 c24 li-bullet-0"><span class="c1">Clock tree → flip-flop<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span>Physical synthesis mainly worries about:<br>  </span><span class="c14 c13">Estimated network latency</span>` }} />
          <hr className={styles.divider} />
          <h3 id="h.52f8wojkf8rt" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Why PS Cares</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">If clock arrives late:</span>` }} />
          ...
          <hr className={styles.divider} />
          <h3 id="h.8noept239x0x" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Example</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">FF1 clock arrives at 100ps<br></span></li><li class="c3 li-bullet-0"><span class="c1">FF2 clock arrives at 160ps<br> ➡️ Skew = 60ps<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.a02vprpekhw7" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Why Skew is Dangerous</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Positive skew → setup issues<br></span></li><li class="c3 li-bullet-0"><span class="c1">Negative skew → hold issues<br></span></li>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">It is:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Added pessimism in timing<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.jb1cqy2rwzr3" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Why PS Must Account for It</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Even if timing looks clean:</span>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">But PS:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Estimates clock tree behavior<br></span></li><li class="c3 li-bullet-0"><span class="c1">Uses virtual clock trees<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.cimjsz24529c" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 What PS Estimates</span>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Goal:</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c14 c13">Avoid massive timing changes after CTS</span>` }} />
          <hr className={styles.divider} />
          <div className={styles.imageContainer}>
          ...
          <hr className={styles.divider} />
          <h1 id="h.9kqt8k8fzolx" className={styles.h1} dangerouslySetInnerHTML={{ __html: `<span class="c5">📘 MODULE 9</span>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Physical synthesis:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Sees real routing resources ✔️<br></span></li>` }} />
          ...
          <hr className={styles.divider} />
          <h3 id="h.geavewg8veon" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Simple Analogy</span>` }} />
          ...
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">More buffers<br></span></li><li class="c3 li-bullet-0"><span class="c1">Higher switching capacitance<br></span></li>` }} />
          <h3 id="h.2xv5vd721fah" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 On Routability</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Router may fail<br></span></li><li class="c3 li-bullet-0"><span class="c1">Design may not tape out<br></span></li>` }} />
          <hr className={styles.divider} />
          <AdUnit slotId="slot_module8content_mid2" />
          <h2 id="h.8m879ktlhcpa" className={styles.h2} dangerouslySetInnerHTML={{ __html: `<span class="c2">5️⃣ Congestion-Aware Optimization</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Physical synthesis:</span>` }} />
          ...
          <hr className={styles.divider} />
          <hr className={styles.divider} />
          <h1 id="h.nvad0jk2luds" className={styles.h1} dangerouslySetInnerHTML={{ __html: `<span class="c2">📘 MODULE 10</span>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Formula (conceptual):</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Dynamic power ∝ switching × capacitance × voltage²</span>` }} />
          <hr className={styles.divider} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Non-critical paths:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Slow, low-power cells<br></span></li>` }} />
          ...
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Clock gating<br></span></li><li class="c3 li-bullet-0"><span class="c1">Power gating (handled later)<br></span></li>` }} />
          <hr className={styles.divider} />
          <div className={styles.imageContainer}>
          ...
          <hr className={styles.divider} />
          <h1 id="h.mdc3lxkutk08" className={styles.h1} dangerouslySetInnerHTML={{ __html: `<span class="c5">📘 MODULE 11</span>` }} />
          ...
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span>It </span><span class="c14 c13">does NOT do final placement<br></span></li><li class="c3 li-bullet-0"><span>It </span><span class="c14 c13">does NOT do routing<br></span></li><li class="c3 li-bullet-0"><span>It </span><span class="c14 c13">DOES change logic<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.cx2doo278bxq" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 PS Focus Areas</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Physical synthesis:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Sees estimated placement<br></span></li><li class="c3 li-bullet-0"><span class="c1">Sees estimated wire delay<br></span></li><li class="c3 li-bullet-0"><span>Fixes timing using </span><span class="c14 c13">logic changes<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Examples:</span>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Key points:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">It places cells legally<br></span></li><li class="c3 li-bullet-0"><span class="c1">It builds clock tree<br></span></li><li class="c3 li-bullet-0"><span class="c1">It routes wires<br></span></li><li class="c3 li-bullet-0"><span class="c1">It fixes remaining timing physically<br></span></li>` }} />
          <hr className={styles.divider} />
          <h3 id="h.pg960ft5vg80" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 P&amp;R Focus Areas</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">P&amp;R works on:</span>` }} />
          ...
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">PS netlist<br></span></li><li class="c3 li-bullet-0"><span class="c1">Floorplan<br></span></li><li class="c3 li-bullet-0"><span class="c1">CTS planning<br></span></li><li class="c3 li-bullet-0"><span class="c1">Routing optimization<br></span></li>` }} />
          <hr className={styles.divider} />
          <div className={styles.imageContainer}>
          ...
          <hr className={styles.divider} />
          <hr className={styles.divider} />
          <h1 id="h.lgea028kws5x" className={styles.h1} dangerouslySetInnerHTML={{ __html: `<span class="c5">📘 MODULE 12</span>` }} />
          ...
          <hr className={styles.divider} />
          <h3 id="h.w6e7rmgy0un3" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 What Changed Compared to LS Netlist</span>` }} />
          ...
          <hr className={styles.divider} />
          <h1 id="h.z2lqb7eb1egw" className={styles.h1} dangerouslySetInnerHTML={{ __html: `<span class="c5"> MODULE 13</span>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Why?</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Reproducibility<br></span></li><li class="c3 li-bullet-0"><span class="c1">Automation<br></span></li><li class="c3 li-bullet-0"><span class="c1">Regression runs<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Example:</span>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Goal:</span>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c14 c13">Minimize surprises at signoff</span>` }} />
          <hr className={styles.divider} />
          <div className={styles.imageContainer}>
          ...
          <hr className={styles.divider} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c5">PHYSICAL SYNTHESIS ENGINEER SKILLS</span>` }} />
          <h3 id="h.llbwqqljlhkr" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c20 c13">(Career-Focused – VERY IMPORTANT)</span>` }} />
          ...
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c14 c13">Synopsys Design Compiler – Topographical<br></span></li><li class="c3 li-bullet-0"><span class="c14 c13">Fusion Compiler (increasingly common)<br></span></li><li class="c3 li-bullet-0"><span class="c14 c13">Cadence Genus (physical-aware synthesis)<br></span></li>` }} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Not just commands — but:</span>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">You should be able to:</span>` }} />
          ...
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">P&amp;R engineers<br></span></li><li class="c3 li-bullet-0"><span class="c1">Floorplan owners<br></span></li><li class="c3 li-bullet-0"><span class="c1">Clock team<br></span></li><li class="c3 li-bullet-0"><span class="c1">Power team<br></span></li>` }} />
          <h3 id="h.npgw19fiaiux" className={styles.h3} dangerouslySetInnerHTML={{ __html: `<span class="c7">🔹 Good PS Engineer:</span>` }} />
          <ul className={styles.list} dangerouslySetInnerHTML={{ __html: `<li class="c3 li-bullet-0"><span class="c1">Explains issues clearly<br></span></li><li class="c3 li-bullet-0"><span class="c1">Understands P&amp;R pain points<br></span></li><li class="c3 li-bullet-0"><span class="c1">Fixes root causes, not symptoms<br></span></li>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Industry expects:</span>` }} />
          ...
          <hr className={styles.divider} />
          <hr className={styles.divider} />
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c5">MODULE 15</span>` }} />
          <h1 id="h.ntahlogb329" className={styles.h1} dangerouslySetInnerHTML={{ __html: `<span class="c5">COMMON MYTHS &amp; MISTAKES</span>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">All matter together.</span>` }} />
          ...
          <div className={styles.paragraph} dangerouslySetInnerHTML={{ __html: `<span class="c1">Good RTL:</span>` }} />
          ...
          <hr className={styles.divider} />
          <hr className={styles.divider} />
          <h1 id="h.9km1s3ykyj6f" className={styles.h1} dangerouslySetInnerHTML={{ __html: `<span class="c5"> MODULE 16</span>` }} />
          <h1 id="h.wmz7xmgvye1j" className={styles.h1} dangerouslySetInnerHTML={{ __html: `<span class="c5">ZERO → HERO SUMMARY</span>` }} />
          ...
          <hr className={styles.divider} />
          <div className={styles.imageContainer}>
            <img loading="lazy" src="/assets/modules/module8/image3.png" alt="" className={styles.contentImage} />
          </div>
          <AdUnit slotId="slot_module8content" />
        </div>
      </div>
    </div>
  );
