...
const htmlPath = 'module7_unzipped/DFT.html';
...
fs.writeFileSync('extracted_content_module7.json', JSON.stringify(finalContent, null, 2));
console.log(`Extracted ${finalContent.length} items to extracted_content_module7.json using Deep Walker.`);
